...
async function testAndFixExamSchedules() {
    try {
        ...
        if (openingCeremony) {
            ...
            if (new Date(openingCeremony.date).getMonth() !== 8 || new Date(openingCeremony.date).getDate() !== 15) {
        ...
        if (v30Course && v31Course) {
            ...
            if (v30Constraint) {
                ...
                if (
                    !v30Constraint.min_days_before_exam ||
                    !v30Constraint.exam_duration_hours ||
                    !v30Constraint.exam_phases
                ) {
            ...
            if (v31Constraint) {
                // Cập nhật cấu hình thi nếu chưa có
                if (
                    !v31Constraint.min_days_before_exam ||
                    !v31Constraint.exam_duration_hours ||
                    !v31Constraint.exam_phases
                ) {
            ...
            console.log(
                `Tìm thấy ${v30Schedules.length} lịch học V30 và ${v31Schedules.length} lịch học V31 để lên lịch thi`
            );
            ...
            if (v30Schedules.length > 0 && v31Schedules.length > 0) {
                ...
                const classIds = ["680214164ef589aaed4aba30", "680214164ef589aaed4aba31"];
