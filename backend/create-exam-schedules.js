...
async function createExamSchedules() {
    try {
        ...
        console.log(`   V30: ${v30Constraint ? 
            `${v30Constraint.min_days_before_exam} ngày trước, ${v30Constraint.exam_duration_hours} giờ, ${v30Constraint.exam_phases || 1} giai đoạn` 
            : '❌ Không có'}`);
        console.log(`   V31: ${v31Constraint ? 
            `${v31Constraint.min_days_before_exam} ngày trước, ${v31Constraint.exam_duration_hours} giờ, ${v31Constraint.exam_phases || 1} giai đoạn` 
            : '❌ Không có'}`);
        ...
        finalV30Exams.forEach(exam => {
            console.log(`   Tuần ${exam.week_number}, Ngày ${exam.day_of_week}, Giai đoạn ${exam.exam_phase}/${exam.total_phases}`);
        });
        ...
        const v30Complete = v30Phases.length === 5 && 
            v30Phases[0] === 1 && v30Phases[4] === 5;
        const v31Complete = v31Phases.length === 5 && 
            v31Phases[0] === 1 && v31Phases[4] === 5;
